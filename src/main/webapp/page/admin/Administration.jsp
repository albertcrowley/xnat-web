<!-- BEGIN pages/Administration.jsp -->
...
<div style="margin-top: 15px;">
	<h1>Administer <span id="xnat_name"></span></h1>
</div>
...
<!-- script type="text/javascript" src="/xnat17/scripts/Administration.js"></script -->

<!-- END pages/Administration.jsp -->